...
class IslandoraSolrFacets {
  ...
  public static function init($islandora_solr_query) {
    ...
    self::$facet_fields = isset($islandora_solr_query->islandoraSolrResult['facet_counts']['facet_fields']) ? $islandora_solr_query->islandoraSolrResult['facet_counts']['facet_fields'] : [];
