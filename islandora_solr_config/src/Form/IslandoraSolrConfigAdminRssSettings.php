...
class IslandoraSolrConfigAdminRssSettings extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    // Get variables.
    $rss_item = self::config('islandora_solr_config.settings')->get('islandora_solr_config_rss_item');
    $rss_channel = self::config('islandora_solr_config.settings')->get('islandora_solr_config_rss_channel');
